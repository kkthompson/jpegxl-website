/*! jxl.js (niutech/jxl.js multithread) — local patch: MutationObserver also watches img src attribute changes, so decoding triggers when a page swaps src on an existing <img> (DistanceVsEffort.js). Re-apply if re-vendoring. */
