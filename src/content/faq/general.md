...
JPEG XL combines several modern compression techniques to reduce file sizes while preserving visual quality. Unlike traditional JPEG, it uses a perceptual encoding model that prioritizes the details people actually see, allowing it to remove less noticeable information more efficiently. It also supports both lossy and mathematically lossless compression, progressive decoding, efficient handling of HDR and wide-gamut images, and reversible transcoding of existing JPEG files. Together, these technologies enable JPEG XL to deliver higher image quality at smaller file sizes than older image formats.
- - -
...
- Support for forward-looking features:
    ...
    - improved color accuracy and color gamut support through HDR (high dynamic range) and high bit depth support
- - -
...
### How is JPEG XL spelled?

**JPEG XL** is the official name.

Use **JPEG XL**, not **JPEG-XL** or **JPEGXL**. JXL is a common abbreviation and the file extension (.jxl).
- - -